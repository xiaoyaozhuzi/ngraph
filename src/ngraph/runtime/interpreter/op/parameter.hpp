...
class ngraph::runtime::interpreter::ParameterExec : public ExecNode
{
public:
    ...
    ParameterExec(const std::shared_ptr<ngraph::Node> node)
        : ExecNode{node}
...
private:
    std::shared_ptr<const ngraph::op::Parameter> m_node;
};
